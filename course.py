...
class Course:
    ...
    def add_assignment(self, assignment: (str, int)) -> bool:
        ...
        10). It is added to the list of assignments if an assignment with the
        same title is not already in the list and adding its weightage does not
        cause the total weightage to exceed 100. Otherwise it cannot and adding
        fails.
