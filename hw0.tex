...
\noindent\underline{Task}: Implement the methods in the \pyth{Course} class provided in the accompanying file, \texttt{course.py}.

\noindent\underline{Task}: Implement the methods in the \pyth{Schedule} class provided in the accompanying file, \texttt{schedule.py}.
